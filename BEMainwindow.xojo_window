...
Begin Window BEMainwindow
   ...
   Begin Label DateLabel
      ...
      Width           =   46
   End
   Begin PopupMenu MonthPopupMenu
      AutoDeactivate  =   True
      Bold            =   False
      DataField       =   ""
      DataSource      =   ""
   ...
   Begin Separator Separator2
      ...
      Width           =   260
   End
   Begin PushButton AddEventPushButton
      AutoDeactivate  =   True
      Bold            =   False
      ButtonStyle     =   "0"
      Cancel          =   False
	...
	#tag Method, Flags = &h0
		Sub handle_events()
		  ...
		  for i = 0 to n
		    ...
		    if i=0 or from_date.TotalSeconds < new_from.TotalSeconds then
		    ...
		    if i=0 or to_date.TotalSeconds > new_to.TotalSeconds then
